...
const (
	...
	// SatoshisInCARI is the number of
	// Satoshis in 1 CARI (10^8).
	SatoshisInCARI = 100000000
	...
	// CARI operations because anything
	...
	// of any transaction hash in CARI.
	TransactionHashLength = 64

	// NullData is returned by carid
...
// Source: https://cariops.org/en/tools/calc-size/
const (
...
// of a CARI transaction that must be satisfied to spend
// the output.
...
// CARI transaction that satisfies the ScriptPubKey
...
// BlockchainInfo is information about the CARI network.
...
// Block is a raw CARI block (with verbosity == 2).
type Block struct {
...
// Transaction is a raw CARI transaction.
...
// Input is a raw input in a CARI transaction.
type Input struct {
...
// Output is a raw output in a CARI transaction.
type Output struct {
...
// metadata from CARI inputs and outputs.
