...
import (
	...
	mocks "github.com/coinbase/rosetta-cari/mocks/services"
...
func TestConstructionService(t *testing.T) {
	...
	cfg := &configuration.Configuration{
		...
		Params:   cari.TestnetParams,
		Currency: cari.TestnetCurrency,
	}
	...
	metadata := &constructionMetadata{
		ScriptPubKeys: []*cari.ScriptPubKey{
			{
	...
	// Test Submit
	cariTransaction := "" // nolint
	mockClient.On(
		"SendRawTransaction",
		ctx,
		cariTransaction,
