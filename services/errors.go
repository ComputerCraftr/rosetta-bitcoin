...
var (
	...
	// ErrNotReady is returned when carid is not
	// yet ready to serve queries.
	ErrNotReady = &types.Error{
		Code:      2, //nolint
		Message:   "CARId is not ready",
		Retriable: true,
	}

	// ErrCARId is returned when carid
	// errors on a request.
	ErrCARId = &types.Error{
		Code:    3, //nolint
		Message: "CARId error",
	}
	...
	// cari.ScriptPubKeys to construct a transaction.
	...
	// cari.ScriptPubKey cannot be parsed during construction.
